...
> *The record: positions, training, delivered work, published output, and where the full paper trail sits.*
...
- **A public analytical tool.** The [Monetary Architecture Online Tool](https://monetary-architecture.com/), built with the Global Climate Forum: the euro area's monetary architecture rendered as navigable, practitioner-facing balance-sheet analysis, open to anyone.
- **Models built to be interrogated.** Balance-sheet and stock-flow-consistent models of monetary architectures; Input-Output and scenario models of the defence-industrial base; long-run financial-flow analysis.
- **Briefings to government and industry.** Strategic briefings and decision-relevant economic assessments delivered at the UKDSC, inside the Ministry of Defence ecosystem.
...
Peer-reviewed articles in *Socio-Economic Review*, the *Journal of Financial Regulation*, *Competition & Change*, *European Law Open*, the *Review of Evolutionary Political Economy* and *The Japanese Political Economy*. 

Alongside these: a PhD thesis, a GEGI study for the Boston University Global Development Policy Center, a contribution to *The State of Capitalism* (Verso), and working papers with SOAS, SSRN and SocArXiv.
...
**Tools**: R and Python for macro-financial modelling and data work; Excel; LaTeX.
...
Teaching at SOAS: Outstanding Teaching Award (2024-25), Best Use of Technology Enhanced Learning (2023-24), and a nomination for Postgraduate Research Supervisor of the Year (2024-25).
...
> The short version is on the [[Dr Matteo Giordano\|front page]]. Where the work lives: [[Cargo & Collateral\|Cargo & Collateral]] · [[Advisory\|Work with me]] · [[Research Projects/Research Projects\|Research Projects]]
