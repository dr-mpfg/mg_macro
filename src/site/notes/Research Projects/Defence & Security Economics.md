...
## 1 · Defence-industrial structure & resilience

> How defence production is linked across sectors, where supply-chain and strategic dependencies concentrate, and what industrial resilience requires. I use **Input-Output modelling** to trace inter-sectoral linkages and spillovers across strategic sectors, alongside sector-level industrial assessment.

## 2 · Alliances, trade & burden-sharing

> The economics of security cooperation and defence trade. I use **gravity models** to study bilateral defence and industrial flows — including NATO and allied contexts — and the structural forces shaping them.

## 3 · Fiscal sustainability of defence

> Whether and how elevated defence commitments can be financed over the long run. This connects defence spending to sovereign debt dynamics, fiscal-monetary interaction, and the wider macroeconomic constraints I study elsewhere on this site.

## 4 · Capability, productivity & measurement

> Frameworks for measuring defence-industrial productivity and performance, and scenario-based assessment of investment gaps and capability shortfalls. Methodologically this draws on **stock-flow-consistent (SFC)** accounting, **VAR** models, and scenario analysis.
